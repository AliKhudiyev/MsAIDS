...
def light():
	...
	glLightfv(GL_LIGHT1, GL_AMBIENT, GLfloat_4(0.0, 0.8, 0.4, 1.0))
	glLightfv(GL_LIGHT1, GL_DIFFUSE, GLfloat_4(0.0, 0.0, 0.0, 1.0))
	glLightfv(GL_LIGHT1, GL_SPECULAR, GLfloat_4(0.2, 0.5, 0.0, 1.0))
	glLightfv(GL_LIGHT1, GL_POSITION, GLfloat_4(0.0, 0.0, 0.0, 1.0));   
	glLightModelfv(GL_LIGHT_MODEL_AMBIENT, GLfloat_4(0.2, 0.2, 0.2, 1.0))
	glEnable(GL_LIGHT1)
